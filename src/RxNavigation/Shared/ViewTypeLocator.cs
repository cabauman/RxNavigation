...
namespace ReactiveUI
{
    ...
    public sealed class ViewTypeLocator : IEnableLogger
    {
        ...
        /// </returns>
        public Type ResolveView<T>(T viewModel, string contract = null)
            where T : class
        {
        ...
        private Type AttemptViewResolutionFor(Type viewModelType, string contract)
        {
        ...
        private Type AttemptViewResolution(string viewTypeName, string contract)
        {
            try
            {
                ...
                var service = Locator.Current.GetService(viewType, contract) as Type;
                ...
                var implementsIViewFor = typeof(IViewFor).IsAssignableFrom(service);

                if (!implementsIViewFor)
                {
